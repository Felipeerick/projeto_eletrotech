...
<html lang="pt-br">
    ...
    CNPJ 94055394500 - TELEFONE: {{Auth::user()->tel}}<br> Técnico: {{Auth::user()->name}} </h5>

        <h2 style="margin: -70px 0 10px 260px;">Ordem de Serviço</h2>

        <span style="margin-left: 310px;">{{ $order->status }} </span>

        <table border="1px solid" width='100%' style="margin: 20px 0 20px 0;">
            <thead>
                <tr>   
                    <th>N° da OS</th>
        ...
        <table border="1px solid" width='100%' style="margin: 10px 0 20px 0;">
            <thead>
                <tr>   
        ...
        <table border="1px solid" width='100%' style="margin: 20px 0px;">
            <thead>
                <tr>   
                    <th>Equipamento</th>
                    <th>Modelo</th>
            ...
            <tbody>
                ...
                <textarea readonly  name='technicalReport' style="width: 220px; height:150px; resize:none;" placeholder="Leave a comment here" id="Laudo técnico">{{ $order->technicalReport }}</textarea>
                    ...
                    <span style="position: absolute; left:470px;top:436px;"> Defeito ou motivo </span>
                     <textarea readonly name='defect' placeholder="Leave a comment here" style="width: 220px; height:150px; resize:none; position:absolute; left:467px; top:452px;"id="Defeito ou motivo">{{ $order->defect }}</textarea>

                     <span style="position: absolute; left:237px;top:436px;">Observações</span>
                     <textarea readonly name='observation' placeholder="Leave a comment here" style="width: 220px; height:150px; resize:none; position:absolute;  left:234px;top:452px;   ;" id="Observações">{{ $order->observation }}</textarea>
    ...
    <h5 style="margin-top: 20px;">Termo de Garantia</h5>
