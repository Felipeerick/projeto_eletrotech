...
@section('title', 'Edite a Ordem de Serviço')
@section('content')
        ...
        <form action="{{route('orderService.update', $order->id)}}" method="POST">
            ...
            <div class="d-flex">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ $order->tel }}" name='tel' onkeypress="checkTel()" maxlength="14" id="tel" pattern="[0-9]{2} [0-9]{1} [0-9]{4}-[0-9]{4}" class="form-control" required placeholder="71 9 9999-9999">
                </div>
                <div class="mb-3  mx-3">
                    <label for="equipment" class="form-label">Equipamento</label>
                    <input type="text" value="{{ $order->equipment }}" style="width: 220px;"  name='equipment' class="form-control" id="equipment" required placeholder="Ex:Televisor">
                </div>
            </div>
            <div class="d-flex">
                <div class="mb-3">
                    <label for="model" class="form-label">Modelo</label>
                    <input type="text" value="{{ $order->model }}" style="width: 220px;" name='model' class="form-control" id="model" required placeholder="Ex:PN321Av">
                </div>
                <div class="mb-3 mx-3">
                    <label for="brand" class="form-label">Marca</label>
                    <input type="text" value="{{ $order->brand }}" style="width: 220px;" name='brand' class="form-control" id="brand" required placeholder="Ex:Sansung">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 mx-3">
                    ...
                    <input type="text" value="{{ $order->serialNumber }}" style="width: 220px;" name='serialNumber' class="form-control" id="serialNumber" required placeholder="Ex:23343242">
                </div>
            </div>
            <div class="d-flex">
                ...
                <div class="form-floating">
                    <textarea class="form-control" name='observation' placeholder="Leave a comment here" id="Observações" style="width: 300px; height:150px; resize:none;">{{ $order->observation }}</textarea>
            ...
            <div class="d-flex">
                ...
                <div class="mx-3">
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ $order->valueProduct }}" style="width: 220px;" placeholder="Ex:33" name="valueProduct" required class="form-control" id="valueProduct">
                    </div>
                    <div>
                        <label for="warrantyProduct" class="form-label">Garantia do Produto</label>
                        <input type="number" value="{{ $order->warrantyProduct }}" style="width: 220px;" placeholder="Somente números inteiros Ex:3" name="warrantyProduct" required class="form-control" id="warrantyProduct">
                    </div>
                </div>
                <div>
                    <label for="discountProduct" class="form-label">Desconto do Produto</label>
                    <input type="text" value="{{ $order->discountProduct }}" style="width: 220px;" name="discountProduct" placeholder="Somente números inteiros Ex:3" required class="form-control" id="discount">
                </div>
            </div>
            <hr>
            ...
            <div class="d-flex">
                ...
                <div class="mx-3">
                    <div class="mb-3">
                        ...
                        <input type="text" style="width: 220px;"  value="{{ $order->valueService }}" placeholder="Ex:33,00" name="valueService" required class="form-control" id="valueService">
                    </div>
                    <div class="mb-3">
                        <label for="warrantyService" class="form-label">Garantia do Serviço</label>
                        <input type="number" style="width: 220px;" value="{{ $order->warrantyService }}" placeholder="Somente números inteiros Ex:3" name="warrantyService" required class="form-control" id="warrantyService">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="discountService" class="form-label">Desconto do Serviço</label>
                    <input type="text" style="width: 220px;" value="{{ $order->discountService }}" name="discountService" placeholder="Somente números inteiros Ex:3" required class="form-control" id="discount">
                </div>
            </div>
